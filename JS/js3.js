setTimeout(() => {
    ...
    function setAudio() {
        ...
        if (audios.length > 0) {
            ...
            //source.src= endpoint + mainData['SoLinhHon_Audio'];
            //audio.appendChild(source);
    ...
    function bindData(data) {
        if (data) {
            ...
            //let thehep = data['SoTheHe_Content'].split('\n');
            //let vanmenhp = data['SoKetNoi1_Content'].split('\n');
            //let linhhonp = data['SoKetNoi2_Content'].split('\n');
            //let tiemthucp = data['SoPhanHoiTiemThuc_Content'].split('\n');
            //let trucgiacp = data['SoTuDuyTrucGiac_Content'].split('\n');
